  ...
  return (
    <main className="home-canvas bgblue">
      <div className="home-container bgblue">
        ...
        <div className="relative z-10 flex w-full max-w-[800px] flex-col items-center gap-3 mx-auto px-6 pt-3 pb-1 mt-10 max-[1024px]:absolute max-[1024px]:top-1/2 max-[1024px]:left-1/2 max-[1024px]:flex-[0_0_auto] max-[1024px]:-translate-x-1/2 max-[1024px]:-translate-y-1/2 max-[1024px]:gap-[clamp(8px,1.15dvh,15px)] max-[1024px]:px-5 max-[1024px]:pt-[clamp(8px,1.9dvh,24px)] max-[1024px]:pb-0 min-[768px]:max-[1024px]:gap-[clamp(12px,1.15dvh,16px)] min-[768px]:max-[1024px]:pt-[clamp(14px,1.6dvh,22px)] min-[1025px]:absolute min-[1025px]:top-1/2 min-[1025px]:left-1/2 min-[1025px]:-translate-x-1/2 min-[1025px]:-translate-y-1/2 min-[1025px]:mt-0 min-[1025px]:w-[clamp(420px,42vw,720px)] min-[1025px]:gap-[clamp(12px,1.5dvh,20px)] min-[1025px]:px-0 min-[1025px]:pt-0 min-[1025px]:pb-0 max-[390px]:gap-[clamp(7px,1dvh,10px)] max-[390px]:pt-[clamp(6px,1.2dvh,10px)]">
          <img
          ...
          <Link
            to="/dogourmet"
            className="mt-10 block cursor-pointer outline-none transition duration-180 ease-out hover:-translate-y-0.5 hover:scale-[1.02] active:translate-y-px active:scale-[0.98] max-[1024px]:mt-0"
            aria-label="Ir a catálogo de Nutrición Canina"
          >
            <img
              src={botonNutricionCanina}
              alt="NUTRICIÓN CANINA"
              className="block h-auto w-[min(61vw,440px)] max-[1024px]:w-[clamp(280px,60vw,429px)] max-[1024px]:max-h-[clamp(82px,11dvh,140px)] min-[768px]:max-[1024px]:w-[clamp(455px,51vw,520px)] min-[768px]:max-[1024px]:max-h-[170px] min-[1025px]:w-[clamp(320px,34vw,520px)] max-[390px]:w-[clamp(180px,58vw,300px)] max-[390px]:max-h-[84px]"
            />
          </Link>

          <Link
            to="/donkat"
            className="block cursor-pointer outline-none transition duration-180 ease-out hover:-translate-y-0.5 hover:scale-[1.02] active:translate-y-px active:scale-[0.98]"
